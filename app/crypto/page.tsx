...
const mockPriceHistory = {
  ...
  DOG: [
    ...
    { time: "16:00", price: 0.00005, priceUSD: 0.00001 },
    { time: "20:00", price: 0.00005, priceUSD: 0.00001 },
  ],
};
...
export default function CryptoPage() {
  ...
  const profitLossPercentage =
    mockCryptoHoldings.reduce((total, crypto) => {
      const purchaseValue = crypto.amount * crypto.purchasePrice;
      const currentValue = crypto.amount * crypto.currentPrice;
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600">Portfolio total em Reais</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-gray-600">Portfolio total em Dólares</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p
              className={`text-xs ${totalProfitLoss >= 0 ? "text-green-600" : "text-red-600"}`}
            >
              {showValues
            ...
            <ChartContainer config={chartConfig} className="h-[300px]">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart
                  data={
                    mockPriceHistory[
                      selectedCrypto as keyof typeof mockPriceHistory
                    ]
                  }
                >
                  <XAxis
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">
                        {formatCryptoAmount(crypto.amount, crypto.symbol)}{" "}
                        {crypto.symbol}
                      </span>
                    </div>
                    <div className="flex justify-between text-sm">
            ...
            {mockCryptoHoldings.map((crypto) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <div className="text-sm text-gray-600">
                    {showValues
                      ? formatPrice(crypto.currentPriceUSD, "USD")
                      : "••••••"}
                  </div>
                  <div
                    className={`text-xs ${crypto.change24h >= 0 ? "text-green-600" : "text-red-600"}`}
                  >
                    {crypto.change24h >= 0 ? "+" : ""}
